 ...
 */
final class Version20250216120333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE progression_utilisateur (id INT AUTO_INCREMENT NOT NULL, id_utilisateur_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_BC58001FC6EE5C49 (id_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
