 ...
 */
final class Version20250215170555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE progression_survivant (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, survivant_id INT NOT NULL, faim TINYINT(1) NOT NULL, soif INT NOT NULL, maladie TINYINT(1) NOT NULL, exploration TINYINT(1) NOT NULL, INDEX IDX_1DF6C03BFB88E14F (utilisateur_id), INDEX IDX_1DF6C03BE9AE49B (survivant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
